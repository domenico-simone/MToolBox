...
class BadSequenceType(Exception):
    """Raised when sequence types are not the same"""
    pass
...
class BaseSequence(object):
    ...
    def __setitem__(self, item, value):
		...
		@attention: length of value must be equal to th length of the substituted string
        """
        #uppercase if string
...
class SeqList(FileIO):
    ...
    def add_seq(self, name='', seq='', **kwds):
        ...
        #if it's an instance of the used class
